...
const AutomaticImageUploader: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">Product Image Upload</h2>
      <p className="text-gray-600 mb-6">Just upload your image and we'll automatically enhance it for your product listing</p>
...
export default AutomaticImageUploader;